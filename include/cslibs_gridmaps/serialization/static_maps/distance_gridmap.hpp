...
namespace YAML {
template <>
struct convert<cslibs_gridmaps::static_maps::DistanceGridmap>
{
    static Node encode(const cslibs_gridmaps::static_maps::DistanceGridmap &rhs)
    {
        Node n;
    ...
    static bool decode(const Node& n, cslibs_gridmaps::static_maps::DistanceGridmap &rhs)
    {
        ...
        rhs = cslibs_gridmaps::static_maps::DistanceGridmap(
