...
struct convert<std::shared_ptr<cslibs_gridmaps::static_maps::Gridmap<Tp,T>>>
{
    static Node encode(const typename cslibs_gridmaps::static_maps::Gridmap<Tp,T>::Ptr &rhs)
    {
        Node n;
        if (!rhs)
            return n;
    ...
    static bool decode(const Node& n, typename cslibs_gridmaps::static_maps::Gridmap<Tp,T>::Ptr &rhs)
    {
        ...
        rhs.reset(new cslibs_gridmaps::static_maps::Gridmap<Tp,T>(
