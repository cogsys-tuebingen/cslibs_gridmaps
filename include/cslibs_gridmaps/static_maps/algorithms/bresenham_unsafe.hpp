#ifndef CSLIBS_GRIDMAPS_STATIC_BRESENHAM_UNSAFE_HPP
#define CSLIBS_GRIDMAPS_STATIC_BRESENHAM_UNSAFE_HPP
...
public:
    ...
    inline BresenhamUsafe& operator++()
    {
        if(done())
            return *this;
...
private:
    ...
    {
        return steep_ ? (index_[0] * step_ + index_[1])
                      : (index_[1] * step_ + index_[0]);
    }
...
#endif // CSLIBS_GRIDMAPS_STATIC_BRESENHAM_UNSAFE_HPP
